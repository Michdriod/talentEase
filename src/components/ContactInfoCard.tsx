...
const contacts: ContactItem[] = [
  ...
  { customIcon: LinkedInIcon, label: "LinkedIn", value: "TalentEase HR Services", href: site.linkedin },
  { customIcon: InstagramIcon, label: "Instagram", value: "talenteasehr", href: site.instagram },
  { customIcon: YouTubeIcon, label: "YouTube", value: "TalentEase HR", href: site.youtube },
];
